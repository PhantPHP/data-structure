...
use Phant\DataStructure\Web\UserAgent;
...
{
    public function testGetDeviceFromString()
    {
        $this->assertSame(Device::Desktop, UserAgent::getDeviceFromString('Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.124 Safari/537.36'));
        $this->assertSame(Device::Mobile, UserAgent::getDeviceFromString('Mozilla/5.0 (iPhone; CPU iPhone OS 14_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/14.0 Mobile/15A372 Safari/604.1'));
        $this->assertSame(Device::Tablet, UserAgent::getDeviceFromString('Mozilla/5.0 (iPad; CPU OS 14_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/14.0 Mobile/15A372 Safari/604.1'));
    }
    ...
    public function testUserAgentParsingFailed(): void
    {
        $invalidAgentString = 'Browser_unknown/5.0 (OperatingSysteme 1.0) AppleWebKit/537.36 (KHTML, like Gecko) Browser/ Safari/537.36';
    ...
    public function testNoExceptionIsThrown(string $userAgentString)
    {
